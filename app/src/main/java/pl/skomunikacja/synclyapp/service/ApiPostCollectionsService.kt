...
interface ApiPostCollectionsService {
    ...
    @POST(value = "api/v1/post-collections/create/{userId}")
    suspend fun createPostCollection(
        @Path("userId") userId: Long,
        @Body postCollectionRequest: PostCollectionRequest
    ): Response<PostCollection>
